...
| account      | `String` | lineID (optional)   |
...
| Name         | Type     | Description                                                                    |
| ------------ | -------- | ------------------------------------------------------------------------------ |
| account      | `String` | lineID(用'x'進行模糊搜尋, ex.'b079010xx')                                      |
| username     | `String` | 名字                                                                           |
| nickname     | `String` | 綽號                                                                           |
| profile      | `String` | 自介                                                                           |
...
- juniorForm: 若上面的 `Identity` 值為 `"junior"`，後端會將資料填入 juniorForm
  ...
  | gpa | `Number` | `4.3` | gpa (0 ~ 4.3) |
  | email | `String` | `example@gmail.com` | 電子信箱 |
  | account | `String` | `"B12345678"` | lineID |
...
- 學弟妹
  ...
  | gpa | `Number` | `4.3` | gpa (0 ~ 4.3) |
  | email | `String` | `example@gmail.com` | 電子信箱 |
  | studentID | `String` | `"B12345678"` | lineID |
...
註冊(by lineID &amp; email)，.env 設定 newReg=true 使用新註冊規則
